...
export default function StakingPage() {
    ...
    useEffect(() => {
        ...
        if (isHomeLoading || isStakingLoading) {
            setIsLoading(true)
        }
        else{
            setIsLoading(false)
    ...
    }, [isLoading, isTabletOrMobile, isLandOrMobile, isHomeLoading, isStakingLoading]);
    AOS.init();
    ...
    return (
        <>
            ...
            <div className="sections" >
                ...
                <SeasonSection setIsLoading={setIsStakingLoading}/>
            </div>
        </>
    )
}
